...
- The thermal stage mode list in the Toolbox settings is now sorted from
  weakest to strongest: Smart modes first (Silent → Soft → Strong), then
  fixed fan/pump pairs by pump and fan (20-40 … 100-100).
